...
* Programming Languages: Java, Python, C/C++, Unix, LaTex, UML, SQL, HTML/CSS, JavaScript
* Databases: MySQL, SQLite, MariaDB
* Operating Systems: Linux, Windows, OSX
* Web Development: Worpress, Wix, Weebly
...
* Applications
** Text Editors: Emacs, Vim, Eclipse, GEdit, Notepad++, Sublime Text
